...
public class BDSqlieDao extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table placar(_id integer primary key autoincrement,pontos text not null,acertos text not null,erros text not null,nome text not null);");
    }
